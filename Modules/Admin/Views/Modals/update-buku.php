               ...
               <div class="col-12">
                ...
                <div class="col-md-6">
                    ...
                    <div class="dropdown position-relative custom-dropdown-container" id="dropdown-penulis">
                        <input type="text" value="<?php echo esc($buku->buku_penulis) ?>" name="buku_penulis" class="form-select dropdown-toggle" placeholder="Ketik atau pilih nama penulis" autocomplete="off" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="col-md-6">
                    ...
                    <div class="dropdown position-relative custom-dropdown-container" id="dropdown-penerbit">
                        <input type="text" value="<?php echo esc($buku->buku_penerbit) ?>" name="buku_penerbit" class="form-select dropdown-toggle" placeholder="Ketik atau pilih nama penerbit" autocomplete="off" data-bs-toggle="dropdown" aria-expanded="false">
                        <ul class="dropdown-menu w-100" style="max-height: 200px; overflow-y: auto;">
        ...
        $('#add-buku').submit(function(event) {
            ...
            $.ajax({
                ...
                .done(function(data) {
                    ...
                    $('#btn020').prop('disabled', false).text('Update');
                })
        });
