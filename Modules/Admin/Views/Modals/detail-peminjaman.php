...
$denda = $peminjaman->peminjaman_denda ?? ($terlambat * option('denda')['option_desc1']);$statusCfg = [
...
<!-- <div class="d-flex gap-2">
    ...
    <button class="btn btn-success btn-sm flex-grow-1"
        ...
        <i class="bi bi-patch-check me-1"></i>Konfirmasi Kembali
    </button>
    <?php endif; ?>
</div> -->
...
function konfirmasiKembali(code, judul, denda) {
    ...
    Swal.fire({
        ...
        $.post('<?= site_url('admin/postdata/Buku/konfirmasi_kembali') ?>', {
            code: code,
        ...
        }).fail(() => Swal.fire('Gagal', 'Terjadi kesalahan, coba lagi.', 'error'));
    });
}
</script>
